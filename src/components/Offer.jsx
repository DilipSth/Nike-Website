    ...
    <div className='lg:py-24 py-12 lg:px-16 px-8'>
        <div className='flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container'>
            <div className='flex-1'>
                <img src="/offer.png" alt="offers" width='773' height='687' className='object-contain w-full max-w-full h-auto'/>
            </div>
            <div className='flex flex-col flex-1'>
                ...
                <div className='mt-11 flex flex-wrap gap-4'>
                    ...
                    <button className='flex justify-center items-center gap-2 px-7 py-4 border-none text-lg leading-none rounded-full bg-[#FF6452] text-white hover:scale-105 transition-transform duration-300'>Learn More</button>
                </div>
            </div>
        </div>
    </div>
